...
const ItemCountContainer = ({ Item, hideButton, inDetail }) => {

  const { cartItems, addItem, isInCart } = useShoppingCart(); 
        ...
        inDetail ?
          <>
            <div className="product-added">
              <p>Producto agregado <br/><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16">
